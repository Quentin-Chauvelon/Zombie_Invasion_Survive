...
function ShoulderCamera.new(weaponsSystem)
	...
	self.normalCrosshairScale = 0.25
	self.zoomedCrosshairScale = 0.1
	...
	self.touchSensitivity = Vector2.new(1 / 80, 1 / 80)
	self.zoomedTouchSensitivity = Vector2.new(1 / 150, 1 / 150)
